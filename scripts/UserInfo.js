...
La clase UserInfo es responsable de presentar información sobre 
el usuario en la página. Esta clase debe:
...
objeto con información sobre el usuario. Este método será útil para casos en 
